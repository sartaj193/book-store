...
const CreateSection = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get(`${Server_URL}api/category/te`); // Adjust the URL to your API endpoint
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${Server_URL}api/section/section`, {
        name: sectionName,
